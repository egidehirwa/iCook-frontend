    ...
    <main className="container mx-auto space-y-8">
      ...
      <section className="space-y-4 p-4">
        ...
        <div className="flex gap-4">
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-center text-[red] font-medium">Audric</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-[red] text-center font-medium">Daria</h2>
            <div style={{ borderRadius: "100%", overflow: "hidden", }}>
              <Image
                src={Daria}
                alt=""
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-[red]  text-center font-medium">Kawtar</h2>
            <div style={{ borderRadius: "100%", overflow: "hidden" }}>
              <Image
                src={Kawtar}
                alt=""
        ...
        <div className="flex gap-4">
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-[red]  text-center font-medium">Egide</h2>
            <div style={{ borderRadius: "100%", overflow: "hidden" }}>
              <Image
                src={Egide}
                alt=""
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-[red] text-center font-medium">Edouard</h2>
            <div style={{ borderRadius: "100%", overflow: "hidden" }}>
              <Image
                src={Edouard}
                alt=""
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-sm rounded overflow-hidden shadow-lg">
            <h2 className="text-lg text-[red]  text-center font-medium">Youssef</h2>
            <div style={{ borderRadius: "100%", overflow: "hidden" }}>
              <Image
                src={Youssef}
                alt=""
